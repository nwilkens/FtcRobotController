...
public class FConstants {
    static {
        ...
        FollowerConstants.leftFrontMotorName = "FLdrive";
        FollowerConstants.leftRearMotorName = "BLdrive";
        FollowerConstants.rightFrontMotorName = "FRdrive";
        FollowerConstants.rightRearMotorName = "BRdrive";
